...
import './formResetPasswordStyles.css'
        ...
        <div className='reset-pwd-container'>
            <form className='reset-pwd-actualForm'>
                ...
                <div className='reset-pwd-form-buttons'>
                        <button className='reset-pwd-button-01'>Send Instructions</button>
                        <button className='reset-pwd-button-02'>Back to Sign in</button>  
                </div>                        
